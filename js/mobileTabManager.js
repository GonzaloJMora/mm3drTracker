// Driven by the data-tab / data-section attributes in both pages, never by button
...
(function () {
    ...
    function switchMobileTab(tabName) {
        ...
        if (changed) {
            ...
            updateBackToTop();
            window.dispatchEvent(new CustomEvent("mobileTabChanged", { detail: { tab: tabName } }));
        }
    }

    // ---------- Back to top ----------

    // The button lives in both pages and is hidden above the mobile breakpoint by
